...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'blacklist', name: 'BlacklistManage', component: () => import('@/pages/BlacklistManage.vue'), meta: { auth: true } },
      ...
      { path: 'chat/:userId?', name: 'Chat', component: () => import('@/pages/Chat.vue'), meta: { auth: true } },
